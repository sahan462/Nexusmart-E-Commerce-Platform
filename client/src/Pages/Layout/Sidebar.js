        ...
        >
            <div className="p-4">
                ...
                <dev class="flex flex-col">
                    <div class="flex space-x-4 space-y-0.5 h-24">
                        <img
                            ...
                            alt="Sidebar Logo"
                            className={`w-5 h-5 bg-neutral-50 space-y-10 rounded-full ${isOpen ? 'block' : 'hidden'
                                }`}
                        />
                        {isOpen && (
                            <div>
                                <div className="flex space-x-4 items-stretch  h-24">
                                    <CollapsibleList title={'Products'} items={[['Manage Products', '/productpage'], ['Add New Product', '/addproduct']]} />
                                </div>
                            </div>
                        )}
                    </div>
                    <div class="flex flex-col space-x-4 space-y-0.5 h-24">
                        <div>
                            <img
